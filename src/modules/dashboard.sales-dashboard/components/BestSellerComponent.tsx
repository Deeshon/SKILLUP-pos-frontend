...
const BestSellerComponent = ({isLoading, productList, columns}: TypeProductTableProps) => {
  return (
    <div className="bg-navy-200 border-2 border-navy-300 rounded-lg md:col-span-1">
